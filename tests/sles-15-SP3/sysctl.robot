...
Sysctl_fs_suid_dumpable
    [Documentation]    Set to 2 from 0 for debuging purpose, os not released yet
...
Sysctl_kernel_cap_last_cap
    [Documentation]    15-SP3, set to 39 from 37
    Sysctl Check Param Int    kernel.cap_last_cap    39
...
Sysctl_kernel_printk_devkmsg
    [Documentation]    Change between 15-SP2 and SP3, likely because the os is not released yet
...
Sysctl_kernel_suid_dumpable
    [Documentation]    Set to 2 from 0 for debuging purpose, os not released yet
    Sysctl Check Param Int    kernel.suid_dumpable    2
...
Sysctl_kernel_usermodehelper_bset
    [Documentation]    Set to 255 from 63, likely helpfull before the OS release.
    Sysctl Check Param Int    kernel.usermodehelper.bset    4294967295 255
Sysctl_kernel_usermodehelper_inheritable
    [Documentation]    Set to 255 from 63, likely helpfull before the OS release.
    Sysctl Check Param Int    kernel.usermodehelper.inheritable    4294967295 255
...
Sysctl_net_ipv4_tcp_available_ulp
    Sysctl Check Param Str    net.ipv4.tcp_available_ulp    espintcp
...
Sysctl_user_max_cgroup_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_cgroup_namespaces    7780:7880
...
Sysctl_user_max_ipc_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_ipc_namespaces    7780:7880
Sysctl_user_max_mnt_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_mnt_namespaces    7780:7880
Sysctl_user_max_net_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_net_namespaces    7780:7880
Sysctl_user_max_pid_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_pid_namespaces    7780:7880
Sysctl_user_max_user_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_user_namespaces    7780:7880
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
Sysctl_user_max_uts_namespaces
    [Documentation]    Depends of the RAM resources bsc#1183339#c11
    Sysctl Check Param Int    user.max_uts_namespaces    7780:7880
