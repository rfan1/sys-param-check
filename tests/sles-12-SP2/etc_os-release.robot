...
/etc/os-release
    ...
    ${result} =    Grep File    /etc/os-release     VERSION="12-SP2"
    Should Be Equal    ${result}    VERSION="12-SP2"
    ${result} =    Grep File    /etc/os-release     VERSION_ID="12.2"
    Should Be Equal    ${result}    VERSION_ID="12.2"
    ${result} =    Grep File    /etc/os-release     PRETTY_NAME="SUSE Linux Enterprise Server 12 SP2"
    Should Be Equal    ${result}    PRETTY_NAME="SUSE Linux Enterprise Server 12 SP2"
