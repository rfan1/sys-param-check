...
Sysctl_fs_protected_fifos
    Sysctl Check Param Int    fs.protected_fifos    0
Sysctl_fs_protected_hardlinks
    Sysctl Check Param Int    fs.protected_hardlinks    1
Sysctl_fs_protected_regular
    Sysctl Check Param Int    fs.protected_regular    0
...
Sysctl_kernel_apparmor_display_secid_mode
    Sysctl Check Param Int    kernel.apparmor_display_secid_mode    0
Sysctl_kernel_hung_task_all_cpu_backtrace
    Sysctl Check Param Int    kernel.hung_task_all_cpu_backtrace    0
Sysctl_kernel_io_uring_disabled
    Sysctl Check Param Int    kernel.io_uring_disabled    0
Sysctl_kernel_io_uring_group
    Sysctl Check Param Int    kernel.io_uring_group    -1
Sysctl_kernel_kexec_load_limit_panic
    Sysctl Check Param Int    kernel.kexec_load_limit_panic    -1
Sysctl_kernel_kexec_load_limit_reboot
    Sysctl Check Param Int    kernel.kexec_load_limit_reboot    -1
Sysctl_kernel_max_rcu_stall_to_panic
...
Sysctl_kernel_sched_deadline_period_min_us
    Sysctl Check Param Int    kernel.sched_deadline_period_min_us    100
Sysctl_kernel_split_lock_mitigate
    Sysctl Check Param Int    kernel.split_lock_mitigate    1
Sysctl_kernel_task_delayacct
    Sysctl Check Param Int    kernel.task_delayacct    0
Sysctl_kernel_unsupported
    Sysctl Check Param Int    kernel.unsupported    2
Sysctl_kernel_warn_limit
    Sysctl Check Param Int    kernel.warn_limit    0
...
Sysctl_net_core_netdev_budget_usecs
    Sysctl Check Param Int    net.core.netdev_budget_usecs   8000
...
Sysctl_net_ipv4_conf_all_rp_filter
    Sysctl Check Param Int    net.ipv4.conf.all.rp_filter    2
...
Sysctl_net_ipv4_conf_eth0_accept_redirects
    Sysctl Check Param Int    net.ipv4.conf.eth0.accept_redirects    0
Sysctl_net_ipv4_conf_eth0_accept_source_route
    Sysctl Check Param Int    net.ipv4.conf.eth0.accept_source_route    0
...
Sysctl_net_ipv4_conf_eth0_arp_evict_nocarrier
    Sysctl Check Param Int    net.ipv4.conf.eth0.arp_evict_nocarrier    1
...
Sysctl_net_ipv4_conf_eth0_bc_forwarding
    Sysctl Check Param Int    net.ipv4.conf.eth0.bc_forwarding    0
...
Sysctl_net_ipv4_conf_eth0_drop_gratuitous_arp
    Sysctl Check Param Int    net.ipv4.conf.eth0.drop_gratuitous_arp    0
Sysctl_net_ipv4_conf_eth0_drop_unicast_in_l2_multicast
    Sysctl Check Param Int    net.ipv4.conf.eth0.drop_unicast_in_l2_multicast    0
...
Sysctl_net_ipv4_neigh_eth0_interval_probe_time_ms
    Sysctl Check Param Int    net.ipv4.neigh.eth0.interval_probe_time_ms    5000
...
Sysctl_net_ipv4_neigh_eth0_unres_qlen
    Sysctl Check Param Int    net.ipv4.neigh.eth0.unres_qlen    101
Sysctl_net_ipv4_neigh_eth0_unres_qlen_bytes
    Sysctl Check Param Int    net.ipv4.neigh.eth0.unres_qlen_bytes    212992
...
Sysctl_net_ipv6_conf_eth0_accept_ra_rt_info_min_plen
    Sysctl Check Param Int    net.ipv6.conf.eth0.accept_ra_rt_info_min_plen    0
...
Sysctl_net_ipv6_conf_eth0_accept_redirects
    Sysctl Check Param Int    net.ipv6.conf.eth0.accept_redirects    0
Sysctl_net_ipv6_conf_eth0_accept_source_route
    Sysctl Check Param Int    net.ipv6.conf.eth0.accept_source_route    0
Sysctl_net_ipv6_conf_eth0_accept_untracked_na
    Sysctl Check Param Int    net.ipv6.conf.eth0.accept_untracked_na    0
Sysctl_net_ipv6_conf_eth0_addr_gen_mode
    Sysctl Check Param Int    net.ipv6.conf.eth0.addr_gen_mode    0
...
Sysctl_net_ipv6_conf_eth0_disable_policy
    Sysctl Check Param Int    net.ipv6.conf.eth0.disable_policy    0
Sysctl_net_ipv6_conf_eth0_drop_unicast_in_l2_multicast
    Sysctl Check Param Int    net.ipv6.conf.eth0.drop_unicast_in_l2_multicast    0
Sysctl_net_ipv6_conf_eth0_drop_unsolicited_na
    Sysctl Check Param Int    net.ipv6.conf.eth0.drop_unsolicited_na    0
Sysctl_net_ipv6_conf_eth0_enhanced_dad
    Sysctl Check Param Int    net.ipv6.conf.eth0.enhanced_dad    1
...
Sysctl_net_ipv6_conf_eth0_ioam6_enabled
    Sysctl Check Param Int    net.ipv6.conf.eth0.ioam6_enabled    0
Sysctl_net_ipv6_conf_eth0_ioam6_id
    Sysctl Check Param Int    net.ipv6.conf.eth0.ioam6_id    65535
Sysctl_net_ipv6_conf_eth0_ioam6_id_wide
    Sysctl Check Param Int    net.ipv6.conf.eth0.ioam6_id_wide    4294967295
Sysctl_net_ipv6_conf_eth0_keep_addr_on_down
    Sysctl Check Param Int    net.ipv6.conf.eth0.keep_addr_on_down    0
...
Sysctl_net_ipv6_conf_eth0_mc_forwarding
    Sysctl Check Param Int    net.ipv6.conf.eth0.mc_forwarding    0
...
Sysctl_net_ipv6_conf_eth0_ndisc_evict_nocarrier
    Sysctl Check Param Int    net.ipv6.conf.eth0.ndisc_evict_nocarrier    1
...
Sysctl_net_ipv6_conf_eth0_ndisc_tclass
    Sysctl Check Param Int    net.ipv6.conf.eth0.ndisc_tclass    0
Sysctl_net_ipv6_conf_eth0_proxy_ndp
    Sysctl Check Param Int    net.ipv6.conf.eth0.proxy_ndp    0
Sysctl_net_ipv6_conf_eth0_ra_defrtr_metric
    Sysctl Check Param Int    net.ipv6.conf.eth0.ra_defrtr_metric    1024
...
Sysctl_net_ipv6_conf_eth0_router_solicitation_max_interval
    Sysctl Check Param Int    net.ipv6.conf.eth0.router_solicitation_max_interval    3600
Sysctl_net_ipv6_conf_eth0_router_solicitations
    Sysctl Check Param Int    net.ipv6.conf.eth0.router_solicitations    -1
Sysctl_net_ipv6_conf_eth0_rpl_seg_enabled
    Sysctl Check Param Int    net.ipv6.conf.eth0.rpl_seg_enabled    0
Sysctl_net_ipv6_conf_eth0_seg6_enabled
    Sysctl Check Param Int    net.ipv6.conf.eth0.seg6_enabled    0
Sysctl_net_ipv6_conf_eth0_seg6_require_hmac
    Sysctl Check Param Int    net.ipv6.conf.eth0.seg6_require_hmac    0
...
Sysctl_net_ipv6_neigh_eth0_interval_probe_time_ms
    Sysctl Check Param Int    net.ipv6.neigh.eth0.interval_probe_time_ms    5000
...
Sysctl_net_ipv6_neigh_eth0_unres_qlen
    Sysctl Check Param Int    net.ipv6.neigh.eth0.unres_qlen    101
Sysctl_net_ipv6_neigh_eth0_unres_qlen_bytes
    Sysctl Check Param Int    net.ipv6.neigh.eth0.unres_qlen_bytes    212992
...
Sysctl_net_core_rps_default_mask
    Sysctl Check Param Int    net.core.rps_default_mask    0
Sysctl_net_ipv6_icmp_error_anycast_as_unicast
    Sysctl Check Param Int    net.ipv6.icmp.error_anycast_as_unicast    0
...
Sysctl_vm_memfd_noexec
    Sysctl Check Param Int     vm.memfd_noexec    0
