...
/etc/os-release_VERSION
    ${result} =    Grep File    /etc/os-release     VERSION="12-SP4"
    Should Be Equal    ${result}    VERSION="12-SP4"
/etc/os-release_VERSION_ID
    ${result} =    Grep File    /etc/os-release     VERSION_ID="12.4"
    Should Be Equal    ${result}    VERSION_ID="12.4"
/etc/os-release_PRETTY_NAME
    ${result} =    Grep File    /etc/os-release     PRETTY_NAME="SUSE Linux Enterprise Server 12 SP4"
    Should Be Equal    ${result}    PRETTY_NAME="SUSE Linux Enterprise Server 12 SP4"
/etc/os-release_ID
