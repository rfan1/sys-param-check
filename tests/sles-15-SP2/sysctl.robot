...
Sysctl_fs_epoll_max_user_watches
    [Documentation]    Depends RAM resources
...
Sysctl_fs_procfs-drop-fd-dentries
    Sysctl Check Param Int    fs.procfs-drop-fd-dentries    0
...
Sysctl_kernel_core_pattern
    Sysctl Check Param Str    kernel.core_pattern    |/usr/lib/systemd/systemd-coredump %P %u %g %s %t %c %e
...
Sysctl_kernel_domainname
    Sysctl Check Param Empty    kernel.domainname
...
Sysctl_kernel_sched_latency_ns
    Sysctl Check Param Int    kernel.sched_latency_ns    6000000
...
Sysctl_kernel_sched_min_granularity_ns
    Sysctl Check Param Int    kernel.sched_min_granularity_ns    2000000
...
Sysctl_kernel_sched_wakeup_granularity_ns
    Sysctl Check Param Int    kernel.sched_wakeup_granularity_ns    2500000
...
Sysctl_net_core_bpf_jit_kallsyms
    Sysctl Check Param Int    net.core.bpf_jit_kallsyms    0
...
Sysctl_net_ipv4_tcp_available_ulp
    Sysctl Check Param Empty    net.ipv4.tcp_available_ulp
...
Sysctl_net_ipv4_tcp_fastopen_blackhole_timeout_sec
    Sysctl Check Param Int    net.ipv4.tcp_fastopen_blackhole_timeout_sec    3600
...
Sysctl_net_ipv4_tcp_max_syn_backlog
 ...
 ysctl_net_ipv4_tcp_max_tw_buckets
    [Documentation]    Depends RAM resources
...
Sysctl_net_ipv4_tcp_rx_skb_cache
    Sysctl Check Param Int    net.ipv4.tcp_rx_skb_cache    0
...
Sysctl_net_ipv4_tcp_tx_skb_cache
    Sysctl Check Param Int    net.ipv4.tcp_tx_skb_cache    0
...
Sysctl_user_max_cgroup_namespaces
    Sysctl Check Param Int    user.max_cgroup_namespaces    7700:7900
...
Sysctl_user_max_ipc_namespaces
    Sysctl Check Param Int    user.max_ipc_namespaces    7700:7900
Sysctl_user_max_mnt_namespaces
    Sysctl Check Param Int    user.max_mnt_namespaces    7700:7900
Sysctl_user_max_net_namespaces
    Sysctl Check Param Int    user.max_net_namespaces    7700:7900
Sysctl_user_max_pid_namespaces
    Sysctl Check Param Int    user.max_pid_namespaces    7700:7900
Sysctl_user_max_user_namespaces
    Sysctl Check Param Int    user.max_user_namespaces    7700:7900
Sysctl_user_max_uts_namespaces
    Sysctl Check Param Int    user.max_uts_namespaces    7700:7900
...
Sysctl_vm_unprivileged_userfaultfd
    Sysctl Check Param Int    vm.unprivileged_userfaultfd    1
