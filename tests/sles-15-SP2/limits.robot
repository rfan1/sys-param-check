...
Limit_pending_signals
    [Documentation]    Depends RAM amount
    Bash Builtin Int    ulimit -i    7800:7900
...
Limit_max_user_processes
    [Tags]    FIXED
    [Documentation]    accept minor change (initial value 192080), d032747 27.01.2020
    Bash Builtin Int    ulimit -u    7827:7867
