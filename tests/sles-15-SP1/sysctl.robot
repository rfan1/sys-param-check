...
Sysctl_fs_epoll_max_user_watches
    ...
    Sysctl Check Param Int    fs.epoll.max_user_watches    350000:420000
Sysctl_fs_file-max
    [Documentation]    Depends RAM resources
    Sysctl Check Param Int    fs.file-max    180000:210000
...
Sysctl_kernel_threads-max
    [Documentation]    Depends RAM resources
    Sysctl Check Param Int    kernel.threads-max    14000:16000
...
Sysctl_net_ipv4_tcp_mem
    [Documentation]    Depends RAM resources
    Sysctl Check Param Int    net.ipv4.tcp_mem    20000:24000 27000:32000 41000:47000
...
Sysctl_user_max_cgroup_namespaces
    Sysctl Check Param Int    user.max_cgroup_namespaces    7000:7900
...
Sysctl_user_max_ipc_namespaces
    Sysctl Check Param Int    user.max_ipc_namespaces    7000:7900
Sysctl_user_max_mnt_namespaces
    Sysctl Check Param Int    user.max_mnt_namespaces    7000:7900
Sysctl_user_max_net_namespaces
    Sysctl Check Param Int    user.max_net_namespaces    7000:7900
Sysctl_user_max_pid_namespaces
    Sysctl Check Param Int    user.max_pid_namespaces    7000:7900
Sysctl_user_max_user_namespaces
    Sysctl Check Param Int    user.max_user_namespaces    7000:7900
Sysctl_user_max_uts_namespaces
    Sysctl Check Param Int    user.max_uts_namespaces    7000:7900
...
Sysctl_vm_user_reserve_kbytes
    Sysctl Check Param Int    vm.user_reserve_kbytes    56000:64000
